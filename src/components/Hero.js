    ...
    <div className="bg-[url(../public/home-bg.jpg)] h-2/3 flex flex-wrap items-center justify-center flex-col lg:flex-row">
      <div className="w-full lg:w-1/2 h-1/2 lg:h-full flex items-center justify-center flex-col mt-10">
        <div className="flex gap-5 items-center lg:items-start justify-center flex-col">
          ...
          <span className="flex text-white text-3xl lg:text-5xl gap-2 font-bold">
            I'M <p className="text-[#ad50eb]"> BODEPU HARSHA VARDHAN</p>
          </span>
          <span className="flex text-[#ad50eb] text-xl lg:text-3xl gap-2 font-semibold bg-gray-800 h-20 lg:h-32 w-72 lg:w-96 items-center justify-center px-5 rounded-md shadow-xl capitalize text-center">
            <Type />
          </span>
        </div>
      </div>
