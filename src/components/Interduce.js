      ...
      <div className="w-full lg:w-1/2 h-1/2 lg:h-full flex items-center justify-center flex-col my-10 lg:gap-10">
        ...
        <div className="flex items-center m-auto justify-center w-11/12 lg:w-3/4 lg:mr-10">
          <span className="flex flex-col gap-3 text-white items-start text-base justify-center font-semibold lg:text-lg">
            <p>
              I'm <span className="text-[#ad50eb]">Bodepu Harsha Vardhan</span>, a passionate Full-stack Developer and CSE student at NIT Jamshedpur.  
              I specialize in the MERN stack (MongoDB, Express.js, React, Node.js) and love building scalable web applications.  
              With a strong focus on learning and attention to detail, I’m committed to delivering impactful digital experiences.  
